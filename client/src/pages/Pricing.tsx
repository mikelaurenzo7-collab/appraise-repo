  ...
  return (
    <div className="min-h-screen bg-[oklch(0.975_0.012_85)]">
        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              >
                {plan.highlight && <div className="text-xs font-semibold text-[oklch(0.72_0.12_75)] uppercase tracking-widest mb-3">Most Popular</div>}
                <h3 className={`font-display text-lg font-semibold mb-1 ${plan.highlight ? "text-white" : "text-[oklch(0.18_0.06_255)]"}`}>{plan.name}</h3>
                ...
                <div className={`text-xs mb-8 ${plan.highlight ? "text-white/50" : "text-[oklch(0.55_0.04_255)]"}`}>{plan.sub}</div>
                ...
                <Link href="/get-started" className={`block text-center py-3 rounded text-sm font-semibold transition-all ${plan.highlight ? "btn-gold" : "border border-[oklch(0.18_0.06_255)] text-[oklch(0.18_0.06_255)] hover:bg-[oklch(0.18_0.06_255)] hover:text-white"}`}>
                  {plan.cta}
                </Link>
              </div>
            ))}
      ...
      <section className="bg-[oklch(0.94_0.018_85)] py-20 lg:py-28">
        <div className="container max-w-3xl">
          <span className="gold-rule" />
          <h2 className="font-display text-3xl font-bold text-[oklch(0.18_0.06_255)] mb-8">Frequently Asked Questions</h2>
      ...
      <section className="py-16">
        <div className="container text-center max-w-xl">
          <h2 className="font-display text-2xl lg:text-3xl font-bold text-[oklch(0.18_0.06_255)] mb-4">Ready to Get Started?</h2>
          <p className="text-[oklch(0.45_0.04_255)] mb-8">Enter your address and get your free AI appraisal in seconds.</p>
