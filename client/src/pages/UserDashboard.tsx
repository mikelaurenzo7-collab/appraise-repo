                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between text-xs text-muted-foreground mb-4">
                        <span className="capitalize">
                          {(sub.filingMethod === "automated_express" || sub.filingMethod === "poa") ? "Automated Express" : sub.filingMethod === "automated_standard" ? "Automated Standard" : sub.filingMethod === "pro-se" ? "Pro Se Guided" : "Free Analysis"}
                        </span>
                        {sub.appealDeadline && (
