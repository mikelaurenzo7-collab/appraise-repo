        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              {[
                { icon: <Twitter size={16} />, href: "https://twitter.com/AppraiseAI", label: "Twitter" },
                { icon: <Linkedin size={16} />, href: "https://linkedin.com/company/appraiseai", label: "LinkedIn" },
                { icon: <Github size={16} />, href: "https://github.com/appraiseai", label: "GitHub" },
              ].map((s) => (
                <a
                  key={s.label}
                  href={s.href}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-white/60">
              ...
              <li><Link href="/county-guides" className="hover:text-[#7C3AED] transition-colors inline-flex items-center gap-1 group">County Guides <span className="opacity-0 group-hover:opacity-100 transition-opacity text-[#7C3AED]">→</span></Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-white/60">
              ...
              <li><Link href="/how-it-works" className="hover:text-[#7C3AED] transition-colors inline-flex items-center gap-1 group">How It Works <span className="opacity-0 group-hover:opacity-100 transition-opacity text-[#7C3AED]">→</span></Link></li>
              <li><Link href="/pricing" className="hover:text-[#7C3AED] transition-colors inline-flex items-center gap-1 group">Pricing <span className="opacity-0 group-hover:opacity-100 transition-opacity text-[#7C3AED]">→</span></Link></li>
              ...
              <li><Link href="/referral" className="hover:text-[#7C3AED] transition-colors inline-flex items-center gap-1 group">Referral Program <span className="opacity-0 group-hover:opacity-100 transition-opacity text-[#7C3AED]">→</span></Link></li>
            </ul>
          </div>
